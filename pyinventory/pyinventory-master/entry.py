...
class CategoryScreen(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        layout.button_sales.bind(on_press=self.toAddItemSales)
        layout.button_nonsales.bind(on_press=self.toAddItemNonSales)
    ...
    def toAddItemServices(self, event):
        self.manager.add_widget(AddItemScreen(name="additems", category="SERVICE", manufacturer="Stylist", pre_quantity="0"))
        self.manager.current = "additems"
		
    def toAddItemSales(self, event):
        self.manager.add_widget(AddItemScreen(name="additems", category="SALES", manufacturer="", pre_quantity="1"))
        self.manager.current = "additems"

    def toAddItemNonSales(self, event):
        self.manager.add_widget(AddItemScreen(name="additems", category="NONSALES", manufacturer="", pre_quantity="1"))
        self.manager.current = "additems"
